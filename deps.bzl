...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:G8hexQdV5D4khOXrWG2YuLCFKhWYmWD8bHYaXN5ophk=",
        version = "v0.9.14",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jWjWgHAPDAdqgUr7lAsB3bqB2DKWC3OaA+isfekjRew=",
        version = "v0.3.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JlsVnETOjM2RLQa0Cc1XCIspUdXW3Zenq9P54uXBm6k=",
    ...
    # keep
    go_repository(
        name = "com_github_spf13_cobra_cli",
        importpath = "github.com/spf13/cobra-cli",
        commit = "74762ac083f2c4deffef229c887ffc15beb6ce0d",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:LDLFxHGdlBK8m5i8fOEqEPRTNJunKfxhCvUHAlS3PpM=",
        version = "v1.24.0",
    )
    go_repository(
